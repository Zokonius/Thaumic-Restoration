...
public class WandTriggers {
	...
	public static void addWandTriggers() {
	    ...
	    IWandTrigger.registerWandTrigger(new WandTriggerMultiblock("INFERNALFURNACE", infernalFurnaceBlueprint, 0));
	    ...
	    IWandTrigger.registerWandTrigger(new WandTriggerMultiblock("INFUSION", infusionAltarNormalBlueprint, 0));
	    ...
	    IWandTrigger.registerWandTrigger(new WandTriggerMultiblock("INFUSIONANCIENT", infusionAltarAncientBlueprint, 0));
	    ...
	    IWandTrigger.registerWandTrigger(new WandTriggerMultiblock("INFUSIONELDRITCH", infusionAltarEldritchBlueprint, 0));
	    ...
	    IWandTrigger.registerWandTrigger(new WandTriggerMultiblock("THAUMATORIUM", thaumotoriumBlueprint, 0));
	    ...
	    IWandTrigger.registerWandTrigger(new WandTriggerMultiblock("MINDCLOCKWORK", golempressBlueprint, 0));
	}
