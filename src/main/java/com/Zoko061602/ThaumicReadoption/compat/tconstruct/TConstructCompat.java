package com.Zoko061602.ThaumicReadoption.compat.tconstruct;

import com.Zoko061602.ThaumicReadoption.blocks.BlockBaseFluid;
...
import com.Zoko061602.ThaumicReadoption.lib.FluidHelper;
...
public class TConstructCompat extends ReadoptedCompatModule {
	...
	public void preInit() {
		...
		FMLInterModComms.sendMessage("tconstruct", "blacklistMelting", new ItemStack(ReadoptedItems.itemTRBucket, 1, 0));
