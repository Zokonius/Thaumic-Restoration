package com.Zoko061602.ThaumicReadoption.lib;

import net.minecraft.item.ItemStack;
import net.minecraft.nbt.NBTTagCompound;
import net.minecraft.nbt.NBTTagList;

// This class was copied from vazkii.botania.common.core.helper.ItemNBTHelper
// check out the Botania Mod !
...
public class ItemNBTHelper {
	...
	public static int[] getIntArray(ItemStack stack, String tag) {
		return verifyExistance(stack, tag) ? getNBT(stack).getIntArray(tag) : new int[0];
	}
