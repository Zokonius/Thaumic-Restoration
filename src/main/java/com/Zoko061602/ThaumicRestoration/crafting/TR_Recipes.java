...
public class TR_Recipes {
    ...
    private static void addInfusionRecipes() {
        ...
        recipes.put("MATSTUD_INFUSEDTHAUMIUM.1", addInfusionRecipe("MATSTUD_INFUSEDTHAUMIUM@1", new ItemStack(TR_Items.itemPrimalModulator), 4, new ItemStack(ItemsTC.morphicResonator), aspects, new ItemStack(TR_Items.itemShard),new ItemStack(ItemsTC.plate,1,2),new ItemStack(ItemsTC.mechanismComplex),new ItemStack(ItemsTC.plate,1,2)));
