...
public class CrystalInfusionRecipeCategory implements IRecipeCategory<CrystalInfusionRecipeWrapper> {
	...
	public CrystalInfusionRecipeCategory(IGuiHelper guiHelper){
		...
		overlay_base = guiHelper.createDrawable(new ResourceLocation(ThaumicRestoration.ModID, "textures/gui/crystalInfusionOverlay.png"),0, 0, 127, 127);
		overlay_ped = guiHelper.createDrawable(new ResourceLocation(ThaumicRestoration.ModID, "textures/gui/crystalInfusionOverlay.png"),128, 0, 143, 15);
        overlay_out = guiHelper.createDrawable(new ResourceLocation(ThaumicRestoration.ModID, "textures/gui/crystalInfusionOverlay.png"),144, 0, 175, 31);
	...
	public String getTitle() {
		return "thaumicrestoration.jei.crystalinfusion";
	}

	@Override
	public String getUid() {
		return "thaumicrestoration.crystalinfusion";
	}
