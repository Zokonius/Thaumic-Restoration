...
public class TileStorageRenderer extends TileEntitySpecialRenderer<TileStorage>{

	  public void render(TileStorage ped, double x, double y, double z, float partialTicks, int destroyStage, float alpha){
	  ...
	  private void renderItem(TileStorage ped, double x, double y, double z, float partialTicks, int destroyStage, float alpha){
	  ...
	  private void renderAnimation(TileStorage ped, double x, double y, double z, float partialTicks, int destroyStage, float alpha){
	      float ticks = Minecraft.getMinecraft().getRenderViewEntity().ticksExisted + partialTicks;
	        GL11.glPushMatrix();
